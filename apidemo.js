...
async function search(searchString) {
  ...
  let apiKey = "1a08c634ec1bc9d64558c15c3e88cdbf"; //TODO: Lägg in API-nyckeln från Classroom här. KLAR!
...
function renderResults(res) {
  ...
  allObjects.forEach((mov) => {
    resultDiv.innerHTML += `
    <div class="movie">
      <div class="movie-title">${mov.title}</div>
      <img class="movie-poster" src="https://image.tmdb.org/t/p/w154${mov.poster_path}">
      <div class="movie-text">${mov.release_date}</div>
      <div class="movie-text">${mov.overview}</div>
    </div>
